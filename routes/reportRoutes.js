...
const allowedReportTypes = ['spam', 'harassment', 'hate_speech', 'inappropriate_content', 'impersonation', 'scam', 'other'];
...
router.post('/', protect, [
    ...
    body('reportType').trim().notEmpty().withMessage('Report type is required').isIn(allowedReportTypes).withMessage('Invalid report type'),
